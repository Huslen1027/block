          ...
          <div className="flex flex-col items-start gap-4  ">
            ...
            <div className="flex w-[478px] pb-[18px] justify-center items-center">
              <div className=" flex flex-col w-[478px] h-[317px] gap-6">
                ...
                />
                <input
                  className="flex w-[478px] h-[40px] items-center gap-3 rounded-md border border-[#DCDDDF] bg-[#FFF] text-[#97989F] text-[16px]"
                  type="text"
                  placeholder="Subject"
                />
                <button className="inline-flex py-[10px] px-[16px] justify-center flex-col items-center rounded-md bg-[#4B6BFB] w-[110px] h-[45px]">
